  ...
  for (let restamp of [false, true]) {
    it(`can play a sequence of page animations ` +
      ...
      const promise1 = animatedPageSwitcher._enqueuePageChange({
        ...
        createAnimation: () => { str1 += ',2'; return new Animation1() },
      ...
      const promise2 = animatedPageSwitcher._enqueuePageChange({
        ...
        createAnimation: () => { str2 += ',2'; return new Animation2() },
      ...
      const promise3 = animatedPageSwitcher._enqueuePageChange({
        ...
        createAnimation: () => { str3 += ',2'; return new Animation3() },
      ...
      const promise4 = animatedPageSwitcher._enqueuePageChange({
        ...
        createAnimation: () => { str4 += ',2'; return new Animation4() },
      ...
      const ret4 = await promise4 // Wait for animation to finish
    ...
    it(`enqueues a page change while an animation is already playing ` +
      ...
      const promise1 = animatedPageSwitcher._enqueuePageChange({
        ...
        createAnimation: () => { str += ',2'; return new Animation1() },
      ...
      const promise2 = animatedPageSwitcher._enqueuePageChange({
        ...
        createAnimation: () => { str += ',9'; return new Animation2() },
    ...
    it(`enqueues only one page change while an animation is already playing ` +
      ...
      // Setup page change: Show page 1
      class SetupAnimation { async start () {} stop () {} }
      await animatedPageSwitcher._enqueuePageChange({ getPageB: () => page1 })
      expect(animatedPageSwitcher.animating).to.be.false
      expect(study('div:nth-of-type(1)')).to.eql({ text: '1', hidden: false })
      expect(study('div:nth-of-type(2)')).to.not.exist
      ...
      const promise2 = animatedPageSwitcher._enqueuePageChange({
        ...
        createAnimation: () => { str += ',x2'; return new Animation2() },
      ...
      const promise3 = animatedPageSwitcher._enqueuePageChange({
        ...
        createAnimation: () => { str += ',10'; return new Animation3() },
