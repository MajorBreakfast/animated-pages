 ...
 *   deferred until the page is inserted into the DOM
 ...
 *   - Keep its DOM element: Non-deep property changes won't be propagated
 *     to the page's template instance while the element is detached (Deep
 *     property changes, like the mutation of arrays or setting of
 *     object properties will be propagated, however). If the page is inserted
 *     again later, the element is reused and all property changes that happend
