...
class AnimatedPages extends AnimatedPageSwitcher(Element) {
  ...
  static get properties () {
    return {
      ...
      /**
       * By default `<animated-pages>` sets `position: relative` on itself and
       * styles its children with
       * `position: absolute; top: 0; right: 0; bottom: 0; left: 0;`. Setting
       * the `noStyle` property to `true` prevents this.
       */
      noStyle: {
        type: Boolean,
